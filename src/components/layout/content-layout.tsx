        ...
        >
            ...
            <DropdownMenu position={'end'} trigger={trigger}>
                ...
                <DropDownItem className={s.wrapper}>
                    <Button style={{padding: "0", backgroundColor: "transparent", outline: "none", boxShadow: "none", gap: "0.5rem"}} className={s.button} onClick={myProfileButtonClicked}>
                ...
                <DropdownSeparator />
                <DropDownItem className={s.wrapper}>
                    <Button style={{padding: "0", backgroundColor: "transparent", outline: "none", boxShadow: "none", gap: "0.5rem"}} className={s.button} onClick={logoutButtonClicked}>
